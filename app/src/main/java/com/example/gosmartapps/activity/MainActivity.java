...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String user_success = getIntent().getStringExtra("USERNAME");
        ...
        navUsername.setText(""+user_success);
        Toast.makeText(getApplicationContext(),"wellcome"+user_success,Toast.LENGTH_LONG).show();
